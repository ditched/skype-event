                ...
                _this.requestWithJar.post(postParams, function (error, response, body) {
                    if (!error && response.statusCode == 200) {
                        ...
                        if (skypeAccount.skypeToken && skypeAccount.skypeTokenExpiresIn) {
                           ...
                           var err_message = $('.message_error span').text().trim();
                           if(err_message == 'We need to double-check your details. Please review this page and submit it again.') {
                              $('#captchaContainer').find('img').each(function(index, element) {
                                 console.log(element.attr('src'));
                                 console.log('hi');
                              });
                              //console.log(captchaURL);
                           }
                            Utils.throwError('Failed to get skypetoken.' + "\n" + 'Username or password is incorrect OR you\'ve' +
                                ' hit a CAPTCHA wall. Error:' + "\n" + $('.message_error span').text() + " \n");
                        }
                    }
                    else {
